"""RK University course knowledge base (ported from src/data/courses.js)."""
...
courses = [
    {
        "id": "btech", "name": "B.Tech (Bachelor of Technology)",
        "name_gu": "બી.ટેક (બેચલર ઓફ ટેકનોલોજી)", "school": "School of Engineering",
        "level": "UG", "duration": "4 years (8 semesters)",
        "specializations": ["Computer Science & Engineering", "Artificial Intelligence & Machine Learning",
                             "AI & Data Science", "Information Technology", "Mechanical", "Electrical", "Civil"],
        "eligibility": "12th Science (PCM) pass with at least 45% (40% for reserved category). ACPC / JEE / direct admission accepted.",
    ...
    {
        "id": "diploma-engg", "name": "Diploma in Engineering (D.Engg.)",
        "name_gu": "ડિપ્લોમા ઇન એન્જિનિયરિંગ", "school": "School of Diploma Studies",
        "level": "Diploma", "duration": "3 years (6 semesters)",
    ...
    },
    {
        ...
        "name_gu": "બી.ફાર્મ (બેચલર ઓફ ફાર્મસી)", "school": "School of Pharmacy",
        "level": "UG", "duration": "4 years (8 semesters)", "specializations": [],
        "eligibility": "12th Science (PCB/PCM) pass with at least 45%. PCI-approved program.",
    ...
    },
    {
        ...
        "name_gu": "ફાર્મ.ડી (ડોક્ટર ઓફ ફાર્મસી)", "school": "School of Pharmacy",
        "level": "UG (Doctoral-level professional)", "duration": "6 years (5 academic + 1 year internship)",
        "specializations": [],
    ...
    },
    {
        ...
        "name_gu": "બી.પી.ટી (બેચલર ઓફ ફિઝિયોથેરાપી)", "school": "School of Physiotherapy",
        "level": "UG", "duration": "4.5 years (4 academic + 6 months internship)", "specializations": [],
    ...
    },
    {
        ...
        "name_gu": "બી.સી.એ (બેચલર ઓફ કમ્પ્યુટર એપ્લિકેશન્સ)", "school": "School of Computer Applications",
        "level": "UG", "duration": "3 years (6 semesters)", "specializations": [],
    ...
    },
    {
        ...
        "name_gu": "એમ.સી.એ (માસ્ટર ઓફ કમ્પ્યુટર એપ્લિકેશન્સ)", "school": "School of Computer Applications",
        "level": "PG", "duration": "2 years (4 semesters)", "specializations": [],
        "eligibility": "Graduation with Mathematics at 10+2 or graduate level; min 50%. CMAT/direct.",
    ...
    },
    {
        ...
        "name_gu": "બી.બી.એ (બેચલર ઓફ બિઝનેસ એડમિનિસ્ટ્રેશન)", "school": "School of Management",
        "level": "UG", "duration": "3 years (6 semesters)",
    ...
    },
    {
        ...
        "name_gu": "એમ.બી.એ (માસ્ટર ઓફ બિઝનેસ એડમિનિસ્ટ્રેશન)", "school": "School of Management",
        "level": "PG", "duration": "2 years (4 semesters)",
    ...
    {
        "id": "bsc-agri", "name": "B.Sc. Agriculture",
        "name_gu": "બી.એસ.સી એગ્રીકલ્ચર", "school": "School of Agriculture",
        "level": "UG", "duration": "4 years (8 semesters)", "specializations": [],
...
def knowledge_text() -> str:
    ...
    lines.append(f"Website {university['website']} | Portal {university['admissionsPortal']} | Email {university['email']} | Helpline {', '.join(university['helplines'])}.")
    lines.append("")
    lines.append("COURSES:")
    for c in courses:
        spec = f" Specializations: {', '.join(c['specializations'])}." if c["specializations"] else ""
        lines.append(f"- {c['name']} [{c['level']}, {c['school']}] | Duration: {c['duration']} | "
                     f"Eligibility: {c['eligibility']} | Fees: {c['fees_indicative']} | Placement: {c['placement']}.{spec}")
    lines.append("")
